...
const dimmer_2_slider_value = ref(0)
const dimmer_3_slider_value = ref(0)
...
const dimmer_2_active_switch = computed(() => {
    return Math.ceil(dimmer_2_slider_value.value / (100 / 3))
})
const dimmer_3_active_switch = computed(() => {
    return Math.ceil(dimmer_3_slider_value.value / (100 / 3))
})
...
onMounted(() => {
    ...
    subscribe('data_response_dimmer_4ch_state', 'data_response_dimmer_state', args => {
        ...
        dimmer_2_slider_value.value = Number(dimmer.dimmer_2)
        dimmer_3_slider_value.value = Number(dimmer.dimmer_3)
    });
